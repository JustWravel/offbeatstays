	                                                ...
	                                                <div class="listing-item">
	                                                    <article class="geodir-category-listing fl-wrap">
	                                                        <div class="geodir-category-img">
	                                                            <a href="{{ route('front.property.show', ['state'=> $property->state->slug, 'location'=> $property->location->slug, 'category'=> $property->category->slug, 'slug'=> $property->slug])}}"><img src="{{ asset( $property->image?->first()?->media?->getUrl('card') ?? 'front-assets/images/gal/1.jpg') }}" alt=""></a>
