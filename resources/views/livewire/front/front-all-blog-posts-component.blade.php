<section class="color-bg middle-padding ">
                        ...
                        <div class="container">
                            <div class="flat-title-wrap">
                                ...
                                <h4>Find the latest news and blog posts here</h4>
                            </div>
                        </div>
                    </section>
                    <!--  section  end-->
                    <div class="breadcrumbs-fs fl-wrap">
                        <div class="container">
                            <div class="breadcrumbs fl-wrap"><a href="{{route('front.home')}}">Home</a><span>Blog</span></div>
                        </div>
                    </div>
                    <!-- section-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="post-container fl-wrap">
                                        <!--article-masonry with multiple image slider-->
                                        ...
                                        <div class="article-masonry">
                                            <article class="card-post">
                                                <div class="card-post-img fl-wrap">
                                                    <a href="{{route('front.blog.detail', ['slug'=>$blog->slug])}}"><img  src="{{$blog->image}}"   alt="{{$blog->image}}" style="height:250px"></a>
                                                </div>
                                                <div class="card-post-content fl-wrap">
                                                    <h3><a href="{{route('front.blog.detail', ['slug'=>$blog->slug])}}">{{$blog->name}}.</a></h3>
                                                    <p>{!!$blog->excerpt ?? substr($blog->description, 0, 200)!!}</p>
