							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">All Properties</h5>
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Actions-->
									<a href="{{ route('admin.property.create') }}" class="btn btn-light-primary font-weight-bolder btn-sm">Add New</a>
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap py-5">
										<div class="card-title">
											<h3 class="card-label">View All Properties
											</h3>
										</div>
									</div>
									<div class="card-body">
											...
											<tbody>
												...
												<tr>
													...
													<td nowrap="nowrap">
														...
														<form method="POST" action="{{ route('admin.property.show', ['property' => $property->id]) }}" onsubmit="return confirm('Are you sure ?? Delete this loction!')" style="display: inline;">
														    @csrf
														    @method('DELETE')
