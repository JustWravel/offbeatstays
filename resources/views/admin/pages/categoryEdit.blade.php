							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Edit Category</h5>
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="card card-custom gutter-b example example-compact">
											...
											<!--begin::Form-->
											<form class="form" action="{{ route('admin.category.update', ['category' => $category->id]) }}" method="post" enctype="multipart/form-data">
												<div class="card-body">
													<div class="row">
													...
													<div class="form-group row">
														...
														<div class="col-lg-6 offset-lg-3">
															...
															<div style="padding: 10px;">
																<img src="{{ $category->image }}" height="100" class="img-thumbnail" alt="">
															</div>
															@else
															<div style="padding: 10px;">
													...
													<div class="form-group row">
														...
														<div class="col-lg-6 offset-lg-3">
															...
															<input type="text" class="form-control" placeholder="Enter category name" name="meta_title" value="{{ old('meta_title') ?? $category->meta_title }}" />
															<span class="form-text text-muted">Please enter Meta title</span>
														</div>
														<div class="col-lg-6 offset-lg-3">
															<label>Meta Keywords:</label>
															<input id="kt_tagify_1" class="form-control tagify" name='meta_keywords' placeholder="Keywords" value="{{ old('meta_kewords') ?? $category->meta_keywords }}" />
															<span class="form-text text-muted">Please enter Meta Keywords</span>
														</div>

														<div class="col-lg-6 offset-lg-3">
															<label>Meta Description:</label>
															<textarea class="form-control" placeholder="Enter category Description" name="meta_description">{{ old('meta_description') ?? $category->meta_description }}</textarea>
