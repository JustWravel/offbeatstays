							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Add New Blog Post</h5>
											...
											<form class="form" action="{{ route('admin.blogpost.store') }}" method="post" enctype="multipart/form-data">
												<div class="card-body">
													...
													<div class="form-group row">
														<div class="col-lg-12">
															<label>Title:</label>
															<input type="text" class="form-control" placeholder="Enter post name" name="name" value="{{ old('name') }}" />
															<span class="form-text text-muted">Please enter post title</span>
														</div>
														<div class="col-lg-12">
															<label>Description:</label>
															<textarea class="form-control" placeholder="Enter category Description" id="description" name="description">{{ old('description') }}</textarea>
