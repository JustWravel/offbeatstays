							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">All Amenities</h5>
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Actions-->
									<a href="{{ route('admin.amenity.create') }}" class="btn btn-light-primary font-weight-bolder btn-sm">Add New</a>
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap py-5">
										<div class="card-title">
											<h3 class="card-label">View All Amenities
											</h3>
										</div>
									</div>
									<div class="card-body">
										...
										<table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
											...
											<tbody>
												...
												<tr>
													...
													<td nowrap="nowrap">
														<a href="{{ route('admin.amenity.edit', ['amenity' => $amenity->id]) }}" class="btn btn-sm btn-primary btn-icon" title="Edit details">
															<i class="la la-edit"></i>
														</a>
														<form method="POST" action="{{ route('admin.amenity.show', ['amenity' => $amenity->id]) }}" onsubmit="return confirm('Are you sure ?? Delete this amenity!')" style="display: inline;">
														    @csrf
														    @method('DELETE')
														    <button type="submit" class="btn btn-sm btn-danger btn-icon" title="Delete"><i class="la la-trash"></i></button>
														</form>
														{{-- <a href="{{ route('admin.amenity.show', ['amenity' => $amenity->id]) }}" class="btn btn-sm btn-danger btn-icon" title="Delete">
