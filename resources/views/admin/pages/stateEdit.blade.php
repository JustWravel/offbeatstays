							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Edit State</h5>
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Actions-->
									<a href="{{ route('admin.state.index') }}" class="btn btn-light-primary font-weight-bolder btn-sm">View All</a>
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="card card-custom gutter-b example example-compact">
											...
											<!--begin::Form-->
											<form class="form" action="{{ route('admin.state.update', ['state' => $state->id]) }}" method="post" enctype="multipart/form-data">
												<div class="card-body">
													<div class="row">
													...
													<div class="form-group row">
														<div class="col-lg-6 offset-lg-3">
															...
															<input type="text" class="form-control" placeholder="Enter state name" name="name" value="{{ old('name') ?? $state->name }}" />
														...
														<div class="col-lg-6 offset-lg-3">
															...
															<div style="padding: 10px;">
																<img src="{{ $state->image }}" height="100" class="img-thumbnail" alt="">
															</div>
															@else
															<div style="padding: 10px;">
														...
														<div class="col-lg-6 offset-lg-3">
															...
															<textarea class="form-control" placeholder="Enter state Description" name="description">{{ old('description') ?? $state->description }}</textarea>
															<span class="form-text text-muted">Please enter state description</span>
														</div>
													</div>
													<br>
													<hr/>
													<div class="form-group row">
														...
														<div class="col-lg-6 offset-lg-3">
															...
															<input type="text" class="form-control" placeholder="Enter state name" name="meta_title" value="{{ old('meta_title') ?? $state->meta_title }}" />
															<span class="form-text text-muted">Please enter Meta title</span>
														</div>
														<div class="col-lg-6 offset-lg-3">
															<label>Meta Keywords:</label>
															<input id="kt_tagify_1" class="form-control tagify" name='meta_keywords' placeholder="Keywords" value="{{ old('meta_kewords') ?? $state->meta_keywords }}" />
															<span class="form-text text-muted">Please enter Meta Keywords</span>
														</div>

														<div class="col-lg-6 offset-lg-3">
															<label>Meta Description:</label>
															<textarea class="form-control" placeholder="Enter state Description" name="meta_description">{{ old('meta_description') ?? $state->meta_description }}</textarea>
															<span class="form-text text-muted">Please enter state Meta description</span>
														</div>
													</div>
