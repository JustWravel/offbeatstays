							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Edit Location</h5>
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Actions-->
									<a href="{{ route('admin.location.index') }}" class="btn btn-light-primary font-weight-bolder btn-sm">View All</a>
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="card card-custom gutter-b example example-compact">
											...
											<!--begin::Form-->
											<form class="form" action="{{ route('admin.location.update', ['location' => $location->id]) }}" method="post" enctype="multipart/form-data">
												<div class="card-body">
													<div class="row">
													...
													<div class="form-group row">
														<div class="col-lg-6 offset-lg-3">
															...
															<input type="text" class="form-control" placeholder="Enter location name" name="name" value="{{ old('name') ?? $location->name }}" />
															<span class="form-text text-muted">Please enter location name</span>
														</div>
														<div class="col-lg-6 offset-lg-3">
															<label>Select Parent State:</label>
															<select class="form-control select2" id="state" name="state_id">
																<option value="">Select a State</option>
																@foreach($states as $state)
																	<option value="{{ $state->id }}" {{ (old('state_id') ?? $location->state_id == $state->id ) ? 'selected' : '' }}>{{ $state->name }}</option>
																@endforeach
															</select>
														...
														<div class="col-lg-6 offset-lg-3">
															...
															<div style="padding: 10px;">
																<img src="{{ $location->image }}" height="100" class="img-thumbnail" alt="">
															</div>
															@else
															<div style="padding: 10px;">
																<img src="https://via.placeholder.com/100x100?text=No%20Image" height="100" class="img-thumbnail" alt="">
															</div>
															@endif
														...
														<div class="col-lg-6 offset-lg-3">
															...
															<textarea class="form-control" placeholder="Enter location Description" name="description">{{ old('description') ?? $location->description }}</textarea>
															<span class="form-text text-muted">Please enter location description</span>
														</div>
													</div>
													<br>
													<hr/>
													<div class="form-group row">
														...
														<div class="col-lg-6 offset-lg-3">
															...
															<input type="text" class="form-control" placeholder="Enter location name" name="meta_title" value="{{ old('meta_title') ?? $location->meta_title }}" />
															<span class="form-text text-muted">Please enter Meta title</span>
														</div>
														<div class="col-lg-6 offset-lg-3">
															<label>Meta Keywords:</label>
															<input id="kt_tagify_1" class="form-control tagify" name='meta_keywords' placeholder="Keywords" value="{{ old('meta_kewords') ?? $location->meta_keywords }}" />
															<span class="form-text text-muted">Please enter Meta Keywords</span>
														</div>

														<div class="col-lg-6 offset-lg-3">
															<label>Meta Description:</label>
															<textarea class="form-control" placeholder="Enter location Description" name="meta_description">{{ old('meta_description') ?? $location->meta_description }}</textarea>
															<span class="form-text text-muted">Please enter location Meta description</span>
														</div>
													</div>
