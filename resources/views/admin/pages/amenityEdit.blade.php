							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Edit Amenity</h5>
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="card card-custom gutter-b example example-compact">
											...
											<!--begin::Form-->
											<form class="form" action="{{ route('admin.amenity.update', ['amenity' => $amenity->id]) }}" method="post" enctype="multipart/form-data">
												<div class="card-body">
													<div class="row">
													...
													<div class="form-group row">
														<div class="col-lg-6 offset-lg-3">
															...
															<input type="text" class="form-control" placeholder="Enter amenity name" name="name" value="{{ old('name') ?? $amenity->name }}" />
													...
													<div class="col-lg-6 offset-lg-3">
															...
															<select class="form-control selectpicker" placeholder="Enter amenity name" name="iconclass" id="icons" data-live-search="true" data-size="7" >
																...
																@foreach($fas as $fa)
																<option value="{{$fa[0]}}" @if($fa[0] == $amenity->iconclass) selected @endif data-icon="la la-{{$fa[0]}} font-size-lg bs-icon">{{$fa[0]}}</option>
																@endforeach
															</select>
