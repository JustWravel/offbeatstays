							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Add New Property</h5>
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="card card-custom gutter-b example example-compact">
											...
											<!--begin::Form-->
											<form class="form" action="{{ route('admin.property.store') }}" method="post" enctype="multipart/form-data">
												<div class="card-body">
													<div class="row">
													...
													<div class="form-group row">
														<div class="col-lg-12">
															...
															<input type="text" class="form-control" placeholder="Enter Property name" name="name" value="{{ old('name') }}" />
															<span class="form-text text-muted">Please enter Property name</span>
														</div>
														<div class="col-lg-12">
															<label>Description:</label>
															<textarea class="form-control" placeholder="Enter Property Description" name="description" id="description">{{ old('description') }}</textarea>
														...
														@livewire('admin.state-locations-component')
													
													<div class="form-group row">
														<div class="col-lg-6 ">
															<label>Select Base Category:</label>
													...
													<div class="form-group row">
														...
														<div class="col-lg-6 offset-lg-3">
															...
															<input type="text" class="form-control" placeholder="Enter Property name" name="meta_title" value="{{ old('meta_title') }}" />
														...
														<div class="col-lg-6 offset-lg-3">
															...
															<textarea class="form-control" placeholder="Enter Property Description" name="meta_description">{{ old('meta_description') }}</textarea>
