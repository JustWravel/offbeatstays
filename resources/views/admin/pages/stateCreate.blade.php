							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Add New State</h5>
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="card card-custom gutter-b example example-compact">
											...
											<!--begin::Form-->
											<form class="form" action="{{ route('admin.state.store') }}" method="post" enctype="multipart/form-data">
												<div class="card-body">
													<div class="row">
													...
													<div class="form-group row">
														<div class="col-lg-6 offset-lg-3">
															...
															<input type="text" class="form-control" placeholder="Enter state name" name="name" value="{{ old('name') }}" />
														...
														<div class="col-lg-6 offset-lg-3">
															...
															<textarea class="form-control" placeholder="Enter state Description" name="description">{{ old('description') }}</textarea>
													...
													<div class="form-group row">
														...
														<div class="col-lg-6 offset-lg-3">
															...
															<input type="text" class="form-control" placeholder="Enter state name" name="meta_title" value="{{ old('meta_title') }}" />
														...
														<div class="col-lg-6 offset-lg-3">
															...
															<textarea class="form-control" placeholder="Enter state Description" name="meta_description">{{ old('meta_description') }}</textarea>
