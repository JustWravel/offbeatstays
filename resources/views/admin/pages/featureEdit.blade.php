							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Edit Feature</h5>
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Actions-->
									<a href="{{ route('admin.feature.index') }}" class="btn btn-light-primary font-weight-bolder btn-sm">View All</a>
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="card card-custom gutter-b example example-compact">
											...
											<!--begin::Form-->
											<form class="form" action="{{ route('admin.feature.update', ['feature' => $feature->id]) }}" method="post" enctype="multipart/form-data">
												<div class="card-body">
													<div class="row">
													...
													<div class="form-group row">
														<div class="col-lg-6 offset-lg-3">
															...
															<input type="text" class="form-control" placeholder="Enter feature name" name="name" value="{{ old('name') ?? $feature->name }}" />
