				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="/" class="brand-logo">
							<img alt="Logo" src="{{ asset('admin-assets/assets/media/logos/logo-light.png') }}" />
						</a>
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								...
								<li class="menu-item menu-item-submenu {{ (strpos(Route::currentRouteName(), 'admin.property') === 0 || strpos(Route::currentRouteName(), 'admin.state') === 0 || strpos(Route::currentRouteName(), 'admin.location') === 0 || strpos(Route::currentRouteName(), 'admin.category') === 0) ? 'menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item menu-item-submenu {{ (strpos(Route::currentRouteName(), 'admin.property') === 0) ? 'menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
												<a href="javascript:;" class="menu-link menu-toggle">
												...
												<div class="menu-submenu">
													<i class="menu-arrow"></i>
													<ul class="menu-subnav">
														<li class="menu-item {{ (strpos(Route::currentRouteName(), 'admin.property.index') === 0) ? 'menu-item-active' : '' }}" aria-haspopup="true">
														...
														<li class="menu-item {{ (strpos(Route::currentRouteName(), 'admin.property.create') === 0) ? 'menu-item-active' : '' }}" aria-haspopup="true">
											...
											<li class="menu-item menu-item-submenu {{ (strpos(Route::currentRouteName(), 'admin.state') === 0) ? 'menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
												<a href="javascript:;" class="menu-link menu-toggle">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
												...
												<div class="menu-submenu">
													<i class="menu-arrow"></i>
													<ul class="menu-subnav">
														<li class="menu-item {{ (strpos(Route::currentRouteName(), 'admin.state.index') === 0) ? 'menu-item-active' : '' }}" aria-haspopup="true">
															<a href="{{ route('admin.state.index') }}" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
																<span class="menu-text">State List</span>
															</a>
														</li>
														<li class="menu-item {{ (strpos(Route::currentRouteName(), 'admin.state.create') === 0) ? 'menu-item-active' : '' }}" aria-haspopup="true">
											...
											<li class="menu-item menu-item-submenu {{ (strpos(Route::currentRouteName(), 'admin.location') === 0) ? 'menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
												<a href="javascript:;" class="menu-link menu-toggle">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
												...
												<div class="menu-submenu">
													<i class="menu-arrow"></i>
													<ul class="menu-subnav">
														<li class="menu-item {{ (strpos(Route::currentRouteName(), 'admin.location.index') === 0) ? 'menu-item-active' : '' }}" aria-haspopup="true">
															<a href="{{ route('admin.location.index') }}" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
																<span class="menu-text">Location List</span>
															</a>
														</li>
														<li class="menu-item {{ (strpos(Route::currentRouteName(), 'admin.location.create') === 0) ? 'menu-item-active' : '' }}" aria-haspopup="true">
											...
											<li class="menu-item menu-item-submenu {{ (strpos(Route::currentRouteName(), 'admin.category') === 0) ? 'menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
												<a href="javascript:;" class="menu-link menu-toggle">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
												...
												<div class="menu-submenu">
													<i class="menu-arrow"></i>
													<ul class="menu-subnav">
														<li class="menu-item {{ (strpos(Route::currentRouteName(), 'admin.category.index') === 0) ? 'menu-item-active' : '' }}" aria-haspopup="true">
														...
														<li class="menu-item {{ (strpos(Route::currentRouteName(), 'admin.category.create') === 0) ? 'menu-item-active' : '' }}" aria-haspopup="true">
